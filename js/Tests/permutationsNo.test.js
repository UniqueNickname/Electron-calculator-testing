...
test('РсП: при вводе n < k должен вернуть error', () => {
  expect(calc_permutationsNo(7, 14)).toBe("n должен быть больше или равен k");
});

test('РсП: при вводе 45, 11 должен вернуть 405179306820288000', () => {
  expect(calc_permutationsNo(45, 11)).toBe(405179306820288000);
});

test('РсП: при вводе 5, 4 должен вернуть 120', () => {
  expect(calc_permutationsNo(5, 4)).toBe(120);
});

test('РсП: при вводе 12, 3 должен вернуть 1320,', () => {
